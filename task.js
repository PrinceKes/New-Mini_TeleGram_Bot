document.addEventListener("DOMContentLoaded", function () {
    ...
    function createTaskBox(task) {
      ...
      taskButton.addEventListener("click", function () {
        window.open(task.link, "_blank"); // Open task link in a new tab
    ...
    function handleTaskStart(task, taskBox, taskButton) {
      ...
      taskButton.addEventListener("click", function onCompleteClick() {
        markTaskAsCompleted(task._id, taskBox);
        taskButton.removeEventListener("click", onCompleteClick); // Prevent duplicate listeners
      });
    }
    ...
    function updateUserBalance(reward) {
      fetch(`https://sunday-mini-telegram-bot.onrender.com/api/users/${userId}/balance`, {
        ...
        .then((data) => {
          ...
          displayUpdatedBalance(data.balance); // Display the new balance
        })
